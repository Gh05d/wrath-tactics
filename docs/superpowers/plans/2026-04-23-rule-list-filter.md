...
No version bump in this plan — further features will land before the next release. When ready, run the `/release` slash-command: it bundles version bump / push / tag / GitHub Release / Nexus upload / Discord post per the project's standard flow.
